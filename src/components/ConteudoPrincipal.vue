...
export default {
  name: 'ConteudoPrincipal',
    data() {//Exporta dados do componente
        return {
        ingredientes: ingredientes // Atribui a lista de ingredientes à propriedade 'ingredientes'
        };
    },
    ...
    <main class="conteudo-principal">
        <section>
            ...
            <p v-else class="paragrafo lista-vazia">
                ...
                Sua lista de ingredientes está vazia! Adicione alguns ingredientes para começar a cozinhar.
            </p>
        </section>
